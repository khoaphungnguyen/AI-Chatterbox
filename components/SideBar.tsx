       ...
       <div className="flex flex-col h-screen p-4 overflow-y-auto bg-[#20232b]/50  shadow-md">
         ...
         { (
           <div className="flex justify-center items-center">
             ...
             >
               <button className="flex h-[56px] items-center justify-center gap-2 
               rounded-md bg-gray-50 p-3 font-medium
               hover:bg-red-100 hover:text-red-600 flex-grow  md:p-2 md:px-3 shadow-md transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                 {session?.user.image ? (
                   <Image
